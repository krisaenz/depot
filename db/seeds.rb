...
Product.create!(title: 'Programming Crystal',
  ...
  Product.create!(title: 'Seven Mobile Apps to Rule Them All',
  description:
    %{<p> 
        This book is amazing! The land of the Shire has truly shown an immense 
        growth and praise for technology. To think that hobbits have evolved from 
        manually cooking six meals a day from memory to utilizing hand-held devices 
        to vastly improve their efficiency in the culinary arts is astonishing. Technology 
        can truly be a heroic addition to the world, if used sustainably and with good 
        intentions. Read this book to learn more! 
    </p>},
  image_url: '7apps.jpg',
  price: 80.00)
